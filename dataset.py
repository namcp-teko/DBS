...
from code.utils import ensure_directory_exist
...
class DataSet:
    ...
    def __init__(self, embedding_file, document_file):
        ...
        self.embeddings_p = self.load_embeddings(embedding_file)
...
class SubDataSet:
    ...
    def load_keywords(self, keyword_file, full_data):
        ...
        with open(keyword_file, 'r') as fin:
            for line in fin:
                keyword = line.strip()
                if keyword in full_data.embeddings_p:
    ...
    def load_embeddings(self, full_data):
        embeddings = full_data.embeddings_p
        ret = []
