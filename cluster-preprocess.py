...
def load_keywords(seed_word_file):
    ...
    if len(seed_words) == 0:
        print("trim " + seed_word_file + " is empty")
    return seed_words
...
# input_dir = '/shared/data/czhang82/projects/local-embedding/sp/init/'
