...
def set_default_params():
    ...
    pd['doc_file'] = pd['data_dir'] + 'init/papers.txt'
    # pd['embedding_file'] = pd['data_dir'] + 'init/embeddings.txt'
    pd['doc_keyword_cnt_file'] = pd['data_dir'] + 'init/paper_keyword_cnt.txt'
    # pd['keyword_file'] = pd['data_dir'] + 'init/keywords.txt'
    # output
    pd['input_dir'] = pd['data_dir'] + 'init/'
...
def load_toy_params():
    ...
    pd['doc_file'] = pd['data_dir'] + 'init/papers.txt'
    pd['doc_keyword_cnt_file'] = pd['data_dir'] + 'init/keyword_cnt.txt'
    pd['input_dir'] = pd['data_dir'] + 'init/'
    pd['root_node_dir'] = pd['data_dir'] + 'cluster/'
    pd['n_cluster'] = 2
    pd['filter_thre'] = 0.15
