...
from code.cluster import run_clustering
from code.labeling import run_again_cluster
from code.paras import *
from code.caseslim import main_caseolap
from code.case_ranker import main_rank_phrase
from code.local_embedding_training import main_local_embedding
...
'''
input_dir: the directory for storing the init files that do not change
