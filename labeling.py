...
from code.case_ranker import read_caseolap_result, rank_phrase
...
def run_again_cluster():
	print("learning_algorithms")
	print("information_retrieval")
	print("object_recognition")
	print("intelligent_agents")
	print("security_infrastructure")
	print("software_agents")
	print("network_infrastructure")
	print("...")
	print("-------------------------")
	print("Continue...")
	time.sleep(9300)
